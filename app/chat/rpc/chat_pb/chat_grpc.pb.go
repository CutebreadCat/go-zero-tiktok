...
const (
	...
	ChatService_GetChatRoomUsers_FullMethodName = "/chat.ChatService/GetChatRoomUsers"
	ChatService_StoreChatMessage_FullMethodName = "/chat.ChatService/StoreChatMessage"
)
...
func (c *chatServiceClient) GetChatRoomUsers(ctx context.Context, in *GetChatRoomUsersRequest, opts ...grpc.CallOption) (*GetChatRoomUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetChatRoomUsersResponse)
	err := c.cc.Invoke(ctx, ChatService_GetChatRoomUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) StoreChatMessage(ctx context.Context, in *StoreChatMessageRequest, opts ...grpc.CallOption) (*StoreChatMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StoreChatMessageResponse)
	err := c.cc.Invoke(ctx, ChatService_StoreChatMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	GetChatRoomUsers(context.Context, *GetChatRoomUsersRequest) (*GetChatRoomUsersResponse, error)
	StoreChatMessage(context.Context, *StoreChatMessageRequest) (*StoreChatMessageResponse, error)
...
func (UnimplementedChatServiceServer) JoinChatRoom(context.Context, *JoinChatRoomRequest) (*JoinChatRoomResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method JoinChatRoom not implemented")
}
...
func (UnimplementedChatServiceServer) GetChatRoomUsers(context.Context, *GetChatRoomUsersRequest) (*GetChatRoomUsersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetChatRoomUsers not implemented")
}
func (UnimplementedChatServiceServer) StoreChatMessage(context.Context, *StoreChatMessageRequest) (*StoreChatMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StoreChatMessage not implemented")
}
...
func _ChatService_GetChatRoomUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetChatRoomUsersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GetChatRoomUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GetChatRoomUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetChatRoomUsers(ctx, req.(*GetChatRoomUsersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatService_StoreChatMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreChatMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).StoreChatMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_StoreChatMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).StoreChatMessage(ctx, req.(*StoreChatMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetChatRoomUsers",
			Handler:    _ChatService_GetChatRoomUsers_Handler,
		},
		{
			MethodName: "StoreChatMessage",
			Handler:    _ChatService_StoreChatMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "app/chat/rpc/chat.proto",
}
