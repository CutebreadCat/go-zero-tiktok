...
func (r *VideoLikerRepo) LikeVideo(ctx context.Context, userID, videoID int64) error {
...
func (r *VideoLikerRepo) CancelLikeVideo(ctx context.Context, userID, videoID int64) error {
...
func (r *VideoLikerRepo) GetLikedVideoIDsByUserID(ctx context.Context, userID int64, pageNumber, pageSize int32) ([]int64, int64, error) {
