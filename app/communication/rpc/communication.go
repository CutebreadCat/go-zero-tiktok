...
var configFile = flag.String("f", "etc/communication.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		communication_pb.RegisterCommunicationServiceServer(grpcServer, server.NewCommunicationServiceServer(ctx))
